...
from app.utils.file_processer.call_gemini import generate_response_from_images
...
class ImageOcrParser:
    ...
    def __init__(
        ...
        east_model_path: str = fr'c:\Users\four\Downloads\east_detector.pb'
    ):
        """
    ...
    def parse(
        ...
        try:
            ...
            response_text = generate_response_from_images( images=images_dict)
